...
const NavBar = () => {
  return (
    <>
      <nav className="flex px-1 lg:mt-2 sm:px-8 lg:px-12 mx-auto items-center relative bg-darkest-green max-w-7xl">
        <div className=" flex mx-auto items-center justify-between  w-full  ">
          <h1 className="font-logo text-base md:text-lg lg:text-xl font-semibold rounded-full text-core-green-200 ">
            Saloni.
          ...
          <Popover className="sm:hidden text-core-green-200 text-xs font-sans font-medium py-2 px-4 rounded-3xl ring-1 ring-core-green-800  bg-core-green-900/50">
            ...
            <Popover.Overlay className="fixed z-5 inset-0 bg-darkest-green opacity-100 backdrop-blur-sm  " />
            <Transition
            ...
            >
              <Popover.Panel className="absolute z-10 ">
                <div className="fixed grid inset-x-4 top-7 z-50 origin-top rounded-3xl p-8 ring-1 ring-core-green-800 bg-slate-800  opacity-100 scale-100">
                  {" "}
                  <div className="flex flex-row justify-between">
                    <h6 className="inline-block text-core-green-400 text-sm">
                      Menu
                    </h6>
                    <Popover.Button
                      class="inline-block"
          ...
          <ul className="  hidden sm:flex space-x-7  text-base  ">
            <li className="py-1 px-1  ease-in-out duration-300 font-sans font-semibold text-base/7">
              <a
