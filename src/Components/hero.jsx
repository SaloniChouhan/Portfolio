...
const Hero = () => {
  return (
    <>
      <div className="container flex flex-col  md:text-left text-center h-screen md:h-full mx-auto  px-6 sm:px-6 md:px-10 lg:max-w-7xl ">
        <div className="lg:mt-0 flex flex-col content-center h-screen sm:h-full justify-center sm:pb-14 sm:pt-20">
          <div>
            <p className="lg:text-lg md:text-base text-sm my-1 font-serif font-regular text-core-green-600 ">
              Hi, My name is
            </p>
            <h1 className="text-4xl md:text-5xl lg:text-7xl mt-2 font-mono font-extrabold text-core-green-100 max-w-3xl ">
              Saloni Chouhan
            </h1>
          </div>
          <div className="max-w-2xl">
            <h2 className="font-mono font-normal text-core-green-200/70 text-md mt-8 ">
              ...
              based in Indore {"("} India {")"} with a drive for transforming
              abstract ideas into tangible, user-friendly experiences.
            </h2>
            <div>
              <div className="lg:mt-20 md:mt-12 mt-10 flex justify-center md:justify-start gap-8">
                <a
                  className="group -m-1 p-1"
                  aria-label="Follow on angel"
                  href="https://wellfound.com/u/saloni-chouhan-1"
                >
                  <svg
                    id="Layer_1"
                ...
                >
                  <svg
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                    className="h-6 w-6 lg:h-10 lg:w-10 fill-core-green-200/70 hover:fill-core-green-700"
                  >
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
