...
const Hero = () => {
  return (
    <>
      <div className="container flex flex-col  md:text-left text-left  h-full mx-auto py-8 mt-12 px-6 sm:px-8 lg:px-12 max-w-7xl">
        <div className="lg:mt-0 ">
          <p className="lg:text-xl text-lg my-2 font-serif font-regular text-core-green-600">
            Hi, My name is
          </p>
          <h1 className="text-5xl my-6 font-mono font-bold text-core-green-100 max-w-3xl ">
            Saloni Chouhan
          </h1>
          <h2 className="font-mono font-light text-core-green-100 mt-12">
        ...
        <div>
          <div className="lg:mt-20 md:mt-12 mt-10 flex justify-start gap-6">
            <a
            ...
            >
              <svg
                id="Layer_1"
                className="h-6 w-6 lg:h-10 lg:w-10 fill-core-green-200"
                data-name="Layer 1"
